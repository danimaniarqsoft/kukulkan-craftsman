(function() {
    ...
    var jhiAlertDialog = {
        template: '<div class="alerts" ng-cloak="" role="alert">' +
                        ...
                        '</div>' +
                  '</div>',
        controller: jhiAlertDialogController
    };

    angular
        .module('kukulkancraftsmanApp')
        .component('jhiAlertDialog', jhiAlertDialog);

    jhiAlertDialogController.$inject = ['$scope', 'AlertService', '$rootScope', '$translate'];

    function jhiAlertDialogController ($scope, AlertService, $rootScope, $translate) {
        var vm = this;
        ...
        var cleanHttpErrorListener = $rootScope.$on('kukulkancraftsmanApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                ...
                if (errorHeader) {
                    ...
                    for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                        ...
                        var fieldName = $translate.instant('kukulkancraftsmanApp.' + fieldError.objectName + '.' + convertedField);
