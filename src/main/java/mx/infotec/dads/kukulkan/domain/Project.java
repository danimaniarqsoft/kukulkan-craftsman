...
public class Project implements Serializable {
    ...
    public Project dataStor(DataStor dataStor) {
    ...
    public Project archetype(Archetype archetype) {
    ...
    public String toString() {
        return "Project{" +
            ...
            ", dataStor='" + getDataStor() + "'" +
            ", daoLayerName='" + getDaoLayerName() + "'" +
            ", domainLayerName='" + getDomainLayerName() + "'" +
            ", serviceLayerName='" + getServiceLayerName() + "'" +
            ", exceptionLayerName='" + getExceptionLayerName() + "'" +
            ", webLayerName='" + getWebLayerName() + "'" +
