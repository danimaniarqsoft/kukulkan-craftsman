...
import mx.infotec.dads.kukulkan.config.DefaultProfileUtil;
...
public class KukulkancraftsmanApp {
    ...
    public KukulkancraftsmanApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(KukulkancraftsmanApp.class);
