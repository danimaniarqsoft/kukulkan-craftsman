package mx.infotec.dads.kukulkan.qa.rest;
...
public class DataGeneratorResource {
    ...
    public DataGeneratorResource(DataStoreService dataStoreService) {
     ...
     */
    @DeleteMapping("/data-generation/{id}")
    @Timed
